...
7. Connect to the Virtual Machine using Remote Desktop Protocol (RDP).
8. Verify that the deployed resources are working correctly.
9. Manage, stop, or delete resources when they are no longer needed.
...
After going to https://azure.microsoft.com/en-us/free/, you will click "Try Azure for free." Following this step you will then continue to sign in to an already existing account and or create a new one.
